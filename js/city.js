...
// 		for(let city in barangays) {
// 			this.p.push(city);
// 		}
// 		return this.p;
// 	}
// 	this.getBarangays = function(city) {
// 		if(city.length==0) {
// 			console.error('Please input city name');
// 			return;
// 		}
// 		for(let i=0;i<=barangays[city].length-1;i++) {
// 			this.c.push(barangays[city][i]);
// 		}
// 		return this.c;
// 	}
// 	this.getAllBarangays = function() {
// 		for(let i in barangays) {
// 			for(let j=0;j<=barangays[i].length-1;j++) {
// 				this.a.push(barangays[i][j]);
// 			}
// 		}
// 		this.a.sort();
// 		return this.a;
// 	}
// 	this.showCities = function(element) {
// 		var str = '<option selected disabled>Select City</option>';
// 		for(let i in this.getCities()) {
// 			str+='<option>'+this.p[i]+'</option>';
// 		}
// 		this.p = [];		
// 		document.querySelector(element).innerHTML = '';
...
// 		return this;
// 	}
// 	this.showBarangays = function(city,element) {
// 		var str = '<option selected disabled>Select Barangay</option>';
// 		var elem = '';
// 		if((city.indexOf(".")!==-1 || city.indexOf("#")!==-1)) {
// 			elem = city;
// 		}
// 		else {
// 			for(let i in this.getBarangays(city)) {
// 				str+='<option>'+this.c[i]+'</option>';
// 			}
// 			elem = element;
// 		}
...
// 			Obj.showBarangays(this.value,elem);
// 		}
// 		return this;
// 	}
// }