...
<!-- FOR ERROR DEACTIVATE ACCOUNT -->
<?php if (isset($_GET['o'])) :?>
    <div class="flash-data" data-flashdata="<?= $_GET['o'];?>"></div>
<?php endif; ?>
...
<!-- DEACTIVATE ACCOUNT -->
<script>
// SUCCESS FLAG NG ERROR DEACTIVATE ACCOUNT
const flashdata= $('.flash-data').data('flashdata')
        if (flashdata == 1){
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'This Account is Inactive! Contact Your manager to activate your account.'
            })
        }
    </script>
<!-- END -->
