...
$opt .= "</select>";
        ...
        $query = 'SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, j.JOB_TITLE, employeeid, HIRED_DATE, l.PROVINCE, l.CITY , l.Barangay, l.Unit FROM employee e join location l on l.LOCATION_ID=e.LOCATION_ID join job j on j.JOB_ID=e.JOB_ID  WHERE EMPLOYEE_ID ='.$_GET['id'];
        $result = mysqli_query($db, $query) or die(mysqli_error($db));
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <form role="form" method="post" action="emp_edit1.php">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Employee ID" name="employeeid" value="<?php echo $empid; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Phone Number" maxlength="11" minlength="11" name="phone" value="<?php echo $phone; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <input placeholder="Province"  id="province" name="province" value="<?php echo $prov; ?>" class="form-control" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input placeholder="City"  id="cityy" name="city" value="<?php echo $cit; ?>" class="form-control" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input placeholder="Barangay"  id="barangayy" name="barangay" value="<?php echo $brgy; ?>" class="form-control" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                <input class="form-control" placeholder="Unit" name="unit" value="<?php echo $unit; ?>" class="form-control" required>
                </div>
              </div>
