...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <a type="button" class="btn btn-primary bg-gradient-primary" href="inv_searchfrm.php?proid=<?php echo $proid ?>"><i class="fas fa-fw fa-flip-horizontal fa-share"></i> Back</a>
                
            <div class="card-body">

            <form role="form" method="post" action="inv_edit1.php?id=<?php echo $id ?>&proid=<?php echo $proid ?>&procode=<?php echo $procode ?>">
