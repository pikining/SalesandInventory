    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-dark white topbar mb-4 static-top shadow">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                  if($_SESSION['GENDER']=='Male'){
                    echo 'src="https://i.ibb.co/KyDv6k2/user-male-icon.png"';
                  }else{
                    echo 'src="https://i.ibb.co/ChsfBrc/icon-female-icon.png"';
                  }
                ?>>
